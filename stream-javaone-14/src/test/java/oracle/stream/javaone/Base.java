...
public abstract class Base {
	...
	<T, U, TS extends BaseStream<T, TS>, US extends BaseStream<U, US>, V> V graph(TS source, Function<TS, US> f,
			Function<US, V> t) {
		...
		try {
			V v = StreamGrapher.eval(source, f, t, base, new PrintWriter(new FileOutputStream(dot)));

			Dot.dotToSvg(new FileInputStream(dot), new FileOutputStream(svg));
			return v;
		} catch (IOException e) {
